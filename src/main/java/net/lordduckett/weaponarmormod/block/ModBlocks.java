package net.lordduckett.weaponarmormod.block;

import net.lordduckett.weaponarmormod.WeaponArmorMod;
import net.lordduckett.weaponarmormod.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> AQUARIUM_DEEPSLATE_ORE = registerBlock ("aquarium_deepslate_ore",

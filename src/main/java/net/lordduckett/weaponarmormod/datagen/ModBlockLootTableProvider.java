...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        dropSelf(ModBlocks.AQUARIUM_BLOCK.get());
        //dropSelf(ModBlocks.MAGIC_BLOCK.get());

        add(ModBlocks.AQUARIUM_ORE.get(),
                block -> createOreDrop(ModBlocks.AQUARIUM_ORE.get(), ModItems.RAW_AQUARIUM.get()));
        add(ModBlocks.AQUARIUM_DEEPSLATE_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.AQUARIUM_DEEPSLATE_ORE.get(), ModItems.RAW_AQUARIUM.get(), 1, 3));
